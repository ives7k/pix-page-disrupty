...
const pageVariants = {
  ...
  in: {
    opacity: 1,
    transition: {
      duration: 0.2, // Reduced duration for faster transition
    },
  },
  out: {
    opacity: 0,
    ...
    <AnimatePresence initial={false} mode='wait'>
      ...
      {showFifteenthPage && (
        <motion.div
          ...
          exit="out"
        >
          <FifteenthPage onNext={handleNextFromFifteenthPage} onBack={handleBackFromFifthPage} />
        </motion.div>
      )}
      ...
      {showFourteenthPage && (
        <motion.div
          ...
          exit="out"
        >
          <FourteenthPage onNext={handleNextFromFourteenthPage} onBack={handleBackFromFourthPage} />
        </motion.div>
      )}
      ...
      {showThirteenthPage && (
        <motion.div
          ...
          exit="out"
        >
          <ThirteenthPage onNext={handleNextFromThirteenthPage} onBack={handleBackFromThirdPage} />
        </motion.div>
      )}
